...
func (c *FakeUiV1alpha1) CustomBoards() v1alpha1.CustomBoardInterface {
	return newFakeCustomBoards(c)
}

func (c *FakeUiV1alpha1) NamespaceCustomBoards(namespace string) v1alpha1.NamespaceCustomBoardInterface {
	return newFakeNamespaceCustomBoards(c, namespace)
}
