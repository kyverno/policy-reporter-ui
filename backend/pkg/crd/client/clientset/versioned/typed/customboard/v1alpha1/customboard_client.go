...
func (c *UiV1alpha1Client) CustomBoards() CustomBoardInterface {
	return newCustomBoards(c)
}

func (c *UiV1alpha1Client) NamespaceCustomBoards(namespace string) NamespaceCustomBoardInterface {
	return newNamespaceCustomBoards(c, namespace)
}
