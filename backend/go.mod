...
require (
	...
	github.com/kyverno/policy-reporter-plugins/sdk/api v0.0.0-20260709141654-69cc91a2f5bd
...
replace github.com/markbates/goth => github.com/fjogeleit/goth v1.83.0
