<template>
  ...
  >
    <template #append>
        <v-btn variant="text" class="mr-3" color="white" prepend-icon="mdi-arrow-left" :to="{ name: 'source-source', params: { source }, query: { ...route.query, mode: 'compact' } }">back</v-btn>
    </template>
...
const { kinds, filter, source } = useFilter()
