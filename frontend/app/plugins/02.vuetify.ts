...
import { DisplayMode, Severity, Status } from "~/types/core";
      ...
      themes: {
        [DisplayMode.LIGHT]: {
          colors: {
            ...
            [`severity-${Severity.UNKNOWN}`]: '#9E9E9E',
        ...
        [DisplayMode.DARK]: {
          ...
          colors: {
            ...
            [`severity-${Severity.UNKNOWN}`]: '#717171',
        ...
        [DisplayMode.COLOR_BLIND]: {
          ...
          colors: {
            ...
            [`severity-${Severity.UNKNOWN}`]: '#424242',
        ...
        [DisplayMode.COLOR_BLIND_DARK]: {
          ...
          colors: {
            ...
            [`severity-${Severity.UNKNOWN}`]: '#9E9E9E',
            [`severity-${Severity.INFO}`]: '#2194F3',
            [`severity-${Severity.LOW}`]: '#01579B',
            [`severity-${Severity.MEDIUM}`]: '#FB8A00',
            [`severity-${Severity.HIGH}`]: '#BF360C',
